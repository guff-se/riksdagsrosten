...
?>
  ...
  <div id="wrapper">
  <div class="alert alert-info alert-sand clearfix">Arbetar du för en intresseorganisation eller inom påverkansindustrin? I höst lanserar vi <a href="/organisationer">Riksdagsrösten för Organisationer</a> <a class="btn btn-success pull-right" id="stod-btn" href="/organisationer" target="_blank">Läs mer här →</a></div>
  	<div id="header">
